...
/**
 * Created by Ekaterina on 15.12.2015.
 */
public class FacebookLoginManager extends ReactContextBaseJavaModule {
    ...
    public FacebookLoginManager(ReactApplicationContext reactContext, Context activityContext) {
        super(reactContext);
